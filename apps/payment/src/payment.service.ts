...
import { NOTIFICATIONS_SERVICE, PAYMENT_SERVICE } from '@app/common';
...
export class PaymentService {
  ...
  async createCharge({ id, amount, email }: PaymentCreateChargeDto) {
    ...
    this.notificationService.emit('notify_email', { email, text: `Your Payment of $${amount} has been completed` });
